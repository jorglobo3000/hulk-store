...
insert into Productos (nombre, stock, stock_emergencia, precio_compra, precio_venta, id_categoria, estado, porcentaje_utilidad) values ('Camiseta Hulk talla M', 10, 2, 15.5, 21, 1, 'ACT',5);
insert into Productos (nombre, stock, stock_emergencia, precio_compra, precio_venta, id_categoria, estado, porcentaje_utilidad) values ('Camiseta Hulk talla S', 8, 1,13.5, 17, 1, 'ACT',5);
insert into Productos (nombre, stock, stock_emergencia, precio_compra, precio_venta, id_categoria, estado, porcentaje_utilidad) values ('Camiseta Hulk talla L', 20, 2, 15.5, 21,1, 'ACT',5);

insert into Productos (nombre, stock, stock_emergencia, precio_compra, precio_venta, id_categoria, estado, porcentaje_utilidad) values ('Vaso Thor 12 onz', 1, 0,  8, 15,  2,'ACT',5);

insert into Productos (nombre, stock, stock_emergencia, precio_compra, precio_venta, id_categoria, estado, porcentaje_utilidad) values ('Colgante martillo de Thor', 5, 1, 1.12, 4,  5,'ACT',5);
